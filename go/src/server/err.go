...
var DatabaseError = &HTTPError{Status: http.StatusInternalServerError, Message: "Database Error"}
var FilesystemError = &HTTPError{Status: http.StatusInternalServerError, Message: "Filesystem Error"}
var SonosError = &HTTPError{Status: http.StatusInternalServerError, Message: "Error communicating with Sonos"}
var SonosUnavailableError = &HTTPError{Status: http.StatusServiceUnavailable, Message: "Sonos not available"}
