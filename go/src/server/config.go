...
type SynosConfig struct {
	...
	HTPasswdFile        string `json:"htpasswd" arg:"--htpasswd"`
...
func (cfg *SynosConfig) FileFinder() *musicdb.FileFinder {
	return musicdb.NewFileFinder(cfg.MediaFolder, cfg.MediaPath, cfg.MediaPath)
}
